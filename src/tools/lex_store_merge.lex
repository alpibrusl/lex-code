...
fn params() -> s.ModelSchema {
  { title: "LexStoreMergeArgs",
    description: "3-way structural merge of three SigIds",
    fields: [
      s.required_str("base", []),
      s.required_str("left", []),
      s.required_str("right", []),
    ] }
}
...
fn tool() -> t.Tool {
  t.define(
    "lex_store_merge",
    "3-way structural merge: base, left, right SigIds. Returns merged SigId or conflict details.",
    params(),
    execute)
}
