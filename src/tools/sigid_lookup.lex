...
fn params() -> s.ModelSchema {
  { title: "SigidLookupArgs",
    description: "Find a function by its content-addressed SigId",
    fields: [
      s.required_str("sigid", []),
    ] }
}
...
fn tool() -> t.Tool {
  t.define(
    "sigid_lookup",
    "Look up a function definition by its content-addressed SigId hash. Exact identity, not name-based.",
    params(),
    execute)
}
