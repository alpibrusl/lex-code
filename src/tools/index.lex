...
fn vcs_read_tools() -> List[t.Tool] {
  [ vcs_ast_diff_tool.tool(),
    vcs_op_show_tool.tool(), vcs_op_log_tool.tool(),
    vcs_branch_list_tool.tool(), vcs_branch_current_tool.tool(),
    vcs_branch_show_tool.tool(), vcs_branch_peek_tool.tool(),
    vcs_branch_overlay_tool.tool(),
    vcs_merge_status_tool.tool(),
  ]
}

fn vcs_write_tools() -> List[t.Tool] {
  [ vcs_branch_create_tool.tool(), vcs_branch_use_tool.tool(),
    vcs_merge_start_tool.tool(), vcs_merge_resolve_tool.tool(),
    vcs_merge_defer_tool.tool(), vcs_merge_commit_tool.tool(),
  ]
}
