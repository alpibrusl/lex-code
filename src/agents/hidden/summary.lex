...
fn agent() -> ag.AgentDef {
  { name:    "summary",
    goal:    "Summarize the key outcomes of this coding session: what was built, what was fixed, what tests were added, what type errors were resolved. Be concrete and brief (2-4 sentences).",
